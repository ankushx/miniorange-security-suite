...
/**
 * Class Benchmark
 * @package MiniOrange\BruteForceProtection\Helper
 */
class Benchmark extends AbstractHelper
{
    ...
    /**
     * @var \MiniOrange\BruteForceProtection\Logger\Logger
     */
    public $logger;
     ...
     * @param \MiniOrange\BruteForceProtection\Logger\Logger $logger
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \MiniOrange\BruteForceProtection\Logger\Logger $logger
    ) {
        $this->logger = $logger;
