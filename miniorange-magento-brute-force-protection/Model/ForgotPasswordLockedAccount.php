 ...
 */
class ForgotPasswordLockedAccount extends AbstractModel
{
    /**
     * Lock types constants (no permanent lockout for forgot password)
     */
    ...
    {
        $this->_init(\MiniOrange\BruteForceProtection\Model\ResourceModel\ForgotPasswordLockedAccount::class);
    }
